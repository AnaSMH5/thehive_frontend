      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
                  ...
                  Column(
                    children: [
                      SizedBox(
                        width: 280.27,
                        height: 297.9,
                        child: PhraseHexagon(phrase: 'Explore the hive of entertainment'),
                      ),
                    ],
                  ),
                  ...
                  Column(
                    children: [
                      SizedBox(
                        width: 280.27,
                        height: 297.9,
                        child: PhraseHexagon(phrase: 'Be the voice behind the honey drops'),
                      ),
                    ],
                  ),
                  SizedBox(width: 20),
            ...
            Text(
              'THE BEST OF CINEMA, RATED BY YOU',
              textAlign: TextAlign.center,
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      width: 680,
                      child: PopularMovieReviews(scrollDirection: Axis.vertical),
                    ),
                  ],
                ),
                SizedBox(width: 30), // Separador entre ambos
