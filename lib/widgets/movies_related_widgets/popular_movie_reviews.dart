...
import 'package:frontend/widgets/movies_related_widgets/movie_review.dart'; // Asegúrate de que la ruta sea correcta
...
class _PopularMovieReviewsState extends State<PopularMovieReviews> {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      shrinkWrap: true,
      physics:
          const NeverScrollableScrollPhysics(), // Evita conflicto con el scroll externo
